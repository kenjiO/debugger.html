...
describe("Breakpoints Selectors", () => {
  it("it gets a breakpoint for an original source", () => {
    ...
    expect(getBreakpointsForSource({ breakpoints }, sourceId)).toEqual( matchingBreakpoints );
  });
  ...
  it("it gets a breakpoint for a generated source", () => {
    ...
    expect(getBreakpointsForSource({ breakpoints }, generatedSourceId)).toEqual( matchingBreakpoints );
  });
});
